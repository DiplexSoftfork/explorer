...
exports.api_page = {
  ...
  "public_apis": {
    ...
    "ext": {
      ...
      //
      "utxo": {
        // enabled: Enable/disable the /ext/utxo api endpoint (true/false)
        //          If set to false, the /ext/utxo api will be completely disabled for public use (no definition on the api page and a disabled error msg if you try to call the endpoint directly)
        "enabled": true
      },
...
exports.loadSettings = function loadSettings() {
  ...
  if (json_settings != null) {
    ...
    json_settings = fix_deprecated_setting(json_settings, 'public_api.rpc.sendrawtransaction', 'api_page.public_apis.rpc.sendrawtransaction.enabled');
    json_settings = fix_deprecated_setting(json_settings, 'public_api.rpc.createrawtransaction', 'api_page.public_apis.rpc.createrawtransaction.enabled');
    ...
    json_settings = fix_deprecated_setting(json_settings, 'public_api.ext.utxo', 'api_page.public_apis.ext.utxo.enabled');
